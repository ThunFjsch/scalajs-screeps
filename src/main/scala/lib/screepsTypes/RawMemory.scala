...
object RawMemory extends RawMemory
...
trait RawMemory extends js.Object{
     ...
     */
    val segments: js.Dictionary[Int] = js.native
    /**
     ...
     */
    val foreignSegment: ForeignSegment = js.native
    /**
     ...
     *
     */
    val interShardSegment: String = js.native
    /**
     ...
     */
    def setActiveSegments(ids: js.Array[Int]): Unit = js.native
    /**
     ...
     */
    def setActiveForeignSegments(username: Either[String, Null], id: Option[Int]): Unit = js.native
    /**
     ...
     * @throws if `id` is passed and isn't an integer.
     */
    def setDefaultPublicSegment(id: Either[Int, Null]): Unit = js.native
    /**
     ...
     */
    def setPublicSegments(ids: js.Array[Int]): Unit = js.native
    /**
      * 
      *
      * @return
      */
    var _parsed: js.Dynamic = js.native
}

@js.native
trait ForeignSegment extends js.Object {

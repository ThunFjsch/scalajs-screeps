...
trait Spawning extends js.Object {
  val directions: Option[Short] = js.native
  ...
  val spawn: StructureSpawn = js.native
  def cancel(): Short = js.native
  def setDirections(directions: js.Array[Short]): Short = js.native
}
...
trait StructureSpawn extends OwnedStructureWithStorage {
  ...
  /**
    ...
    * @note CPU Cost: CONST
    */
  def recycleCreep(target: Creep): Short = js.native
